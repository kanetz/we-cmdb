...
INSERT INTO `adm_basekey_code` (`id_adm_basekey`, `id_adm_basekey_cat`, `code`, `value`, `group_code_id`, `code_description`, `seq_no`, `status`) VALUES
	(1, 1, 'AAL', 'App Architecture', NULL, NULL, 1, 'active'),
	(2, 1, 'ADL', 'App Deployment', NULL, NULL, 2, 'active'),
	(3, 1, 'SRL', 'Resource', NULL, NULL, 3, 'active'),
	(4, 1, 'RPL', 'IDC Resource Plan', NULL, NULL, 4, 'active'),
	(5, 1, 'PDL', 'IDC Blueprint', NULL, NULL, 5, 'active'),
	(6, 2, 'AAL', 'App Architecture', NULL, NULL, 1, 'active'),
	(7, 2, 'ADL', 'App Deployment', NULL, NULL, 2, 'active'),
	(8, 2, 'SRL', 'Resource', NULL, NULL, 3, 'active'),
	(9, 2, 'RPL', 'IDC Resource Plan', NULL, NULL, 4, 'active'),
	(10, 2, 'PDL', 'IDC Blueprint', NULL, NULL, 5, 'active'),
	...
	(58, 12, '22', 'Machine Room Design', NULL, NULL, 1, 'active'),
	...
	(68, 14, '16', 'Machine Room', NULL, NULL, 1, 'active'),
	...
	(86, 16, '5', 'Invocation Design', NULL, NULL, 4, 'active'),
	...
	(88, 16, '6', 'Invocation Seq Design', NULL, NULL, 5, 'active'),
...
INSERT INTO `adm_ci_type` (`id_adm_ci_type`, `name`, `description`, `id_adm_tenement`, `table_name`, `status`, `catalog_id`, `ci_global_unique_id`, `seq_no`, `layer_id`, `zoom_level_id`, `image_file_id`, `ci_state_type`) VALUES
	...
	(14, 'IP Address', 'IP Address', NULL, 'ip_addr', 'created', 8, NULL, 3, 3, NULL, 14, NULL),
	(15, 'Instance', 'Instance', NULL, 'running_instance', 'created', 8, NULL, 4, 3, NULL, 15, NULL),
	(16, 'IDC', 'IDC', NULL, 'IDC', 'created', 9, NULL, 1, 4, NULL, 16, NULL),
	(17, 'Network Zone', 'Network Zone', NULL, 'zone', 'created', 9, NULL, 2, 4, NULL, 17, NULL),
	(18, 'Zone Link', 'Zone Link', NULL, 'zone_link', 'created', 9, NULL, 3, 4, NULL, 18, NULL),
	...
	(24, 'Zone Link Design', 'Zone Link Design', NULL, 'zone_link_design', 'created', 10, NULL, 3, 5, NULL, 24, NULL),
...
INSERT INTO `adm_ci_type_attr_base` (`id_adm_ci_type`, `name`, `description`, `input_type`, `property_name`, `property_type`, `length`, `reference_id`, `reference_name`, `reference_type`, `filter_rule`, `search_seq_no`, `display_type`, `display_seq_no`, `edit_is_null`, `edit_is_only`, `edit_is_hiden`, `edit_is_editable`, `is_defunct`, `special_logic`, `status`, `is_system`, `is_access_controlled`, `is_auto`, `auto_fill_rule`, `is_refreshable`) VALUES
	(1, 'Global Unique ID', 'Global Unique ID', 'text', 'guid', 'varchar', 15, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 1, 0, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Key Name', 'Key Name', 'text', 'key_name', 'varchar', 200, NULL, NULL, NULL, NULL, 1, 1, 1, 0, 1, 0, 0, 0, NULL, 'created', 1, 0, 1, NULL, 0),
	(1, 'State', 'State', 'select', 'state', 'int', 15, 7, NULL, NULL, NULL, 2, 1, 2, 0, 0, 0, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Fixed Date', 'Fixed Date', 'text', 'fixed_date', 'varchar', 19, NULL, NULL, NULL, NULL, 3, 1, 3, 1, 0, 0, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Previous Version Guid', 'Previous Version Guid', 'text', 'p_guid', 'varchar', 15, NULL, NULL, NULL, NULL, 0, 0, 0, 1, 0, 1, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Root Guid', 'Root Guid', 'text', 'r_guid', 'varchar', 15, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Description', 'Description', 'textArea', 'description', 'varchar', 1000, NULL, NULL, NULL, NULL, 4, 1, 4, 1, 0, 0, 1, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Code', 'Code', 'text', 'code', 'varchar', 50, NULL, NULL, NULL, NULL, 5, 1, 5, 0, 0, 0, 1, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Orchestration', 'Orchestration', 'select', 'orchestration', 'int', 15, 31, NULL, NULL, NULL, 0, 1, 6, 1, 0, 0, 1, 0, NULL, 'created', 0, 0, 0, NULL, 1),
	(1, 'Orchestration Instance ID', 'Orchestration Instance ID', 'text', 'biz_key', 'varchar', 50, NULL, NULL, NULL, NULL, 0, 0, 0, 1, 0, 0, 1, 0, NULL, 'created', 0, 0, 0, NULL, 1),
	(1, 'Updated By', 'Updated By', 'text', 'updated_by', 'varchar', 50, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 1, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Updated Date', 'Updated Date', 'date', 'updated_date', 'datetime', 1, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 1, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Created_By', 'Created By', 'text', 'created_by', 'varchar', 50, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 1, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0),
	(1, 'Created Date', 'Created Date', 'date', 'created_date', 'datetime', 1, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 1, 0, 0, NULL, 'created', 1, 0, 0, NULL, 0);
